            ...
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-sm text-white uppercase bg-purple-600">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 w-1/4">Adress</th>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        <td>
                            <div class="flex items-center space-x-3">
                                <div class="avatar">
                                    <div class="p-2">
                                        <img src="{{ asset('images/user-default.png') }}" alt="user image" class="rounded-lg w-10">
                                    </div>
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4 w-1/4">{{ $user->category }}</td>
                        <td class="px-6 py-4 w-1/4">{{ $user->adress }}</td>
