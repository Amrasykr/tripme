<x-app-layout>
    ...
    <div class="mb-10">
        <form class="w-full bg-white p-8 shadow-xl rounded-lg">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="content" name="content"></textarea>
                </div>                
              </div>
            <div class="mt-2 flex justify-end">
                <button class="bg-purple-600 text-white px-6 py-2 shadow-lg rounded-md">
                    Submit
                </button>
            </div>
          </form>
