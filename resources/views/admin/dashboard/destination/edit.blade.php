...
<div class="mb-10">
    <form class="w-full bg-white p-8 shadow-xl rounded-lg" enctype="multipart/form-data" method="POST" action="/admin/dashboard/destination/{{ $destination->id }}/update">
        ...
        <input type="hidden" id="latitude" name="latitude" value="{{ old('latitude', $destination->latitude) }}">
        <input type="hidden" id="longitude" name="longitude" value="{{ old('longitude', $destination->longitude) }}">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-3 md:mb-0">
                <div class="bg-second_white rounded py-3 px-4">
                    ...
                    <span id="latDisplay" class="text-tertiary text-sm ml-2">{{ $destination->latitude ?? 'Not selected' }}</span>
                </div>
            </div>
            <div class="w-full md:w-1/2 px-3">
                <div class="bg-second_white rounded py-3 px-4">
                    <span class="text-tertiary text-xs font-bold">LONGITUDE:</span>
                    <span id="lngDisplay" class="text-tertiary text-sm ml-2">{{ $destination->longitude ?? 'Not selected' }}</span>
                </div>
            </div>
        </div>
