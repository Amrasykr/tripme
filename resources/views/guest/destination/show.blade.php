...
@section('content')
    ...
    <div class="relative mt-24">
        <div class="px-4 md:px-0 container" >
            <div class="relative">
                <a href="#">
                    <img src="{{ asset('assets/tumbnail_image/'.$destination->main_image) }}" alt="hero" class="w-full h-96 md:h-[56rem] object-cover rounded-2xl">
                    ...
                    <div class="absolute inset-0 flex flex-col items-start justify-end ml-4 pb-4 md:ml-10 md:pb-10 z-20">
                        ...
                        <div class="w-4/12 md:w-2/12 md:mt-2">
                            <div class="w-full">
                                <a href="/destination/{{ $destination->id }}/book" class="w-full block py-1 px-4 md:py-3 md:px-8 bg-second_white hover:bg-alternate text-tertiary text-lg md:text-2xl rounded-full transition-all duration-500 ease-in-out text-center">
